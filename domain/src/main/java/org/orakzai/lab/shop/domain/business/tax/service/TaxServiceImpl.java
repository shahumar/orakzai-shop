...
import org.orakzai.lab.shop.domain.business.tax.model.TaxBasisCalculation;
...
public class TaxServiceImpl implements TaxService {
	...
	@Override
	public List<TaxItem> calculateTax(OrderSummary orderSummary, Customer customer, MerchantStore store,
		...
		for (ShoppingCartItem item : items) {
			...
			if (subTotal == null) {
				...
				var scale = subTotal.setScale(2, RoundingMode.HALF_UP);
			}
		...
		if (amnt == null) {
			...
			var taxamntScale = amnt.setScale(2, RoundingMode.HALF_UP);
		}
		...
		for (Long taxClassId : taxClassAmountMap.keySet()) {
			...
			var ttScale = totalTaxedItemValue.setScale(2, RoundingMode.HALF_UP);
