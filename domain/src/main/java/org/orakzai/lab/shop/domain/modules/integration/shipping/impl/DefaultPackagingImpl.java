...
public class DefaultPackagingImpl implements Packaging {
	...
	public List<PackageDetails> getBoxPackagesDetails(
		...
		width = Double.valueOf(shippingConfiguration.getBoxWidth()).doubleValue();
		length = Double.valueOf(shippingConfiguration.getBoxLength()).doubleValue();
		height = Double.valueOf(shippingConfiguration.getBoxHeight()).doubleValue();
		weight = Double.valueOf(shippingConfiguration.getBoxWeight()).doubleValue();
		maxweight = Double.valueOf(shippingConfiguration.getMaxWeight()).doubleValue();
