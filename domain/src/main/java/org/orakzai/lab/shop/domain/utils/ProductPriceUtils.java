...
public class ProductPriceUtils {
    ...
    public String getFormatedAmountWithCurrency(Locale locale, org.orakzai.lab.shop.domain.business.reference.currency.model.Currency currency, BigDecimal amount) throws Exception {
        if(amount==null) {
            return "";
        }
    ...
    public String getFormatedAmountWithCurrency(org.orakzai.lab.shop.domain.business.reference.currency.model.Currency currency, BigDecimal amount) throws Exception {
        if(amount==null) {
            return "";
        }
    ...
    public boolean hasDiscount(ProductPrice productPrice) {
        ...
        if(productPrice.getProductPriceSpecialStartDate()!=null
            ...
            if(productPrice.getProductPriceSpecialStartDate()!=null) {
                if(productPrice.getProductPriceSpecialStartDate().isBefore(today)) {
                    if(productPrice.getProductPriceSpecialEndDate()!=null) {
                        if(productPrice.getProductPriceSpecialEndDate().isAfter(today)) {
                            hasDiscount = true;
                        }
                    }
                }
