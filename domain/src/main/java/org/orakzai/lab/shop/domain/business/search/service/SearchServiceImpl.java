...
import org.orakzai.lab.shop.domain.business.search.model.IndexProduct;
import org.orakzai.lab.shop.domain.business.search.model.SearchEntry;
import org.orakzai.lab.shop.domain.business.search.model.SearchFacet;
...
//			keywords.setKeywords(Arrays.asList(response.getInlineSearchList()));
	...
	@Override
	public org.orakzai.lab.shop.domain.business.search.model.SearchResponse search(MerchantStore store, String languageCode, String jsonString, int entriesCount, int startIndex) throws ServiceException {
...
//
//			org.orakzai.lab.shop.domain.business.search.model.SearchResponse resp = new org.orakzai.lab.shop.domain.business.search.model.SearchResponse();
//
//
